package com.messenger.connecto.screen.alpha_notes.tabs.adapter;
...
import com.messenger.connecto.screen.alpha_notes.tabs.SingleNoteActivity;
import com.messenger.connecto.screen.alpha_notes.tabs.user.UserNotes;

import java.util.ArrayList;

public class AllNotesAdapter extends RecyclerView.Adapter<AllNotesAdapter.myholder> {
    Context context;
    ...
    public AllNotesAdapter(Context context, ArrayList<UserNotes> arrayList) {
    ...
    public myholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_for_allnotes, parent, false);
                        ...
                        databaseReference.child(user_note_id).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(context, AllNotesFragment.class);
                                    context.startActivity(intent);
