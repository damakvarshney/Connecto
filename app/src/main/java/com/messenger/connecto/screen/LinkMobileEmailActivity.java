...
public class LinkMobileEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_link_mobile_email);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LinkMobileEmailActivity.this, "Failed to Create User", Toast.LENGTH_SHORT).show();
                            firebaseAuth.getCurrentUser().delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    onPostExecute();
                                    Log.e("Unsuccessful User", "Try again later", task.getException().getCause());
                                    Intent intent = new Intent(LinkMobileEmailActivity.this, RegisterActivity.class);
    ...
    private void save_user_to_database(String uid) {
        ...
        database_user.child(uid).setValue(userInfo).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    onPostExecute();
                    Toast.makeText(LinkMobileEmailActivity.this, "User is Registered Successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(LinkMobileEmailActivity.this,SlideNavigatorActivity.class);
                    overridePendingTransition(R.anim.right_to_left,R.anim.left_to_right);
                    startActivity(intent);
                    finish();
                }else {
